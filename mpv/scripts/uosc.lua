...
local options = {
	timeline_size_min = 0,
	timeline_size_max = 80,
	timeline_size_min_fullscreen = 0,
	timeline_size_max_fullscreen = 110,
	timeline_start_hidden = false,
	timeline_persistency = 'paused, audio',
	timeline_opacity = 1,
	timeline_border = 0,
	timeline_step = 0,
	timeline_cached_ranges = '3d992b:1',
	timeline_font_scale = 1,
	...
	volume_persistency = 'paused, audio',
	volume_opacity = 1,
	volume_border = 0,
	volume_step = 2,
	volume_font_scale = 1.5,
	...
	menu_item_height = 65,
	menu_item_height_fullscreen = 65,
	...
	proximity_out = 120,
	color_foreground = 'ffffff',
	color_foreground_text = '992b83',
	color_background = '992b83',
	color_background_text = 'ffffff',
	total_time = false,
	font_bold = false,
	autohide = false,
...
function Menu:enable_key_bindings()
	...
	menu:add_key_binding('KP8',              'menu-prev1',        self:create_action('prev'), 'repeatable')
	menu:add_key_binding('KP2',            'menu-next1',        self:create_action('next'), 'repeatable')
	menu:add_key_binding('KP4',            'menu-back1',        self:create_action('back'))
	menu:add_key_binding('KP5',           'menu-select1',      self:create_action('open_selected_item'))
	menu:add_key_binding('KP6',           'menu-select',      self:create_action('open_selected_item'))
	menu:add_key_binding('shift+KP5',     'menu-select-soft1', self:create_action('open_selected_item_soft'))
