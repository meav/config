...
alias quit='rm --interactive=never ~/.zsh_history;cp ~/.zsh_history_base ~/.zsh_history;rm --interactive=never ~/.zcompdump-DESKTOP-IF91IT1-5.8;rm --interactive=never ~/.zcompdump;exit'
alias power='echo 00:00:00 > ~/.timer;rm --interactive=never ~/.zsh_history;cp ~/.zsh_history_base ~/.zsh_history;rm --interactive=never ~/.zcompdump-DESKTOP-IF91IT1-5.8;rm --interactive=never ~/.zcompdump;explorer "D:\Users\a\Music\WW\power.vbs"'
alias history='rm --interactive=never ~/.zsh_history_base; cp ~/.zsh_history ~/.zsh_history_base; vim ~/.zsh_history_base'
