...
--END OF SAMPLE REPLACE ]=====]
  ...
  playlist_display_timeout = 999999,
  ...
  style_ass_tags = "{\fnFS Nokio Bold\fs13\b0\bord1}",
  ...
  normal_file="○ %name",
  hovered_file="{\\c&H32CD32&}➔{\\c} %name",
  playing_file="{\\c&H32CD32&}➤{\\c} %name",
  playing_hovered_file="{\\c&H32CD32&}▶{\\c} %name",
...
mp.add_key_binding("KP1", "showplaylist", toggle_playlist)
